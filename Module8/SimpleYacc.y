...
%token BEGIN END CYCLE ASSIGN ASSIGNPLUS ASSIGNMINUS ASSIGNMULT SEMICOLON WRITE VAR PLUS MINUS MULT DIVIDE LPAREN RPAREN COLUMN MOD IF THEN ELSE
%token <iVal> INUM 
%token <dVal> RNUM 
%token <sVal> ID
