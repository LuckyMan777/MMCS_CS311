...
// DateTime: 19.11.2018 12:19:30
// UserName: arudnev
// Input file <SimpleYacc.y - 12.11.2018 12:58:57>
...
public enum Tokens {
    ...
    COLUMN=19,MOD=20,IF=21,THEN=22,ELSE=23,INUM=24,
    RNUM=25,ID=26};
...
#pragma warning restore 649
  ...
  static Parser() {
    ...
    states[11] = new State(new int[]{26,18,24,19,17,20},new int[]{-2,12,-4,30,-5,29,-3,17});
    states[12] = new State(new int[]{13,13,14,23,4,-14,10,-14,23,-14});
    states[13] = new State(new int[]{26,18,24,19,17,20},new int[]{-4,14,-5,29,-3,17});
    states[14] = new State(new int[]{15,15,16,25,20,27,13,-15,14,-15,4,-15,10,-15,23,-15,18,-15,26,-15,3,-15,5,-15,11,-15,12,-15,21,-15,22,-15});
    states[15] = new State(new int[]{26,18,24,19,17,20},new int[]{-5,16,-3,17});
    states[16] = new State(-18);
    states[17] = new State(-22);
    states[18] = new State(-13);
    states[19] = new State(-23);
    states[20] = new State(new int[]{26,18,24,19,17,20},new int[]{-2,21,-4,30,-5,29,-3,17});
    states[21] = new State(new int[]{18,22,13,13,14,23});
    states[22] = new State(-24);
    states[23] = new State(new int[]{26,18,24,19,17,20},new int[]{-4,24,-5,29,-3,17});
    states[24] = new State(new int[]{15,15,16,25,20,27,13,-16,14,-16,4,-16,10,-16,23,-16,18,-16,26,-16,3,-16,5,-16,11,-16,12,-16,21,-16,22,-16});
    states[25] = new State(new int[]{26,18,24,19,17,20},new int[]{-5,26,-3,17});
    states[26] = new State(-19);
    states[27] = new State(new int[]{26,18,24,19,17,20},new int[]{-5,28,-3,17});
    states[28] = new State(-20);
    states[29] = new State(-21);
    states[30] = new State(new int[]{15,15,16,25,20,27,13,-17,14,-17,4,-17,10,-17,23,-17,18,-17,26,-17,3,-17,5,-17,11,-17,12,-17,21,-17,22,-17});
    states[31] = new State(-6);
    states[32] = new State(-7);
    states[33] = new State(new int[]{26,18,24,19,17,20},new int[]{-2,34,-4,30,-5,29,-3,17});
    ...
    states[38] = new State(new int[]{26,18,24,19,17,20},new int[]{-2,39,-4,30,-5,29,-3,17});
    ...
    states[44] = new State(new int[]{19,45,4,-29,10,-29,23,-29});
    ...
    states[50] = new State(new int[]{26,18,24,19,17,20},new int[]{-2,51,-4,30,-5,29,-3,17});
